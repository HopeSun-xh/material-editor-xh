...
const productPath = `/material-editor-xh@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('material-editor-xh', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'material-editor-xh': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
